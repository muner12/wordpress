...
<section class="courses-page-section">
    <div class="container">
        ...
        <div class="courses-breadcrumb mb-4">
            ...
            <span class="courses-breadcrumb-separator">></span>
            <span class="courses-breadcrumb-current">Module 11</span>
        </div>
                ...
                <div class="col-12 col-lg-6 courses-video-column order-1 order-lg-1">
                    <div class="courses-video-container w-100">
                        <div class="courses-video-wrapper w-100 position-relative">
                            <img 
                                src="<?php echo get_template_directory_uri(); ?>/assets/images/week_11.png" 
                                alt="Module 11: Focus on Your Higher Power"
            ...
            <div class="col-12 col-lg-6 courses-details-column order-2 order-lg-2">
                <div class="courses-details-content">
                    ...
                    <div class="courses-details-header mb-4">
                        <h3 class="courses-details-title mb-3">Module 11: Focus on Your Higher Power</h3>
                    ...
                    <div class="courses-description-enhanced">
                        <div class="courses-description-item mb-4" style="padding-left: 28px; border-left: 3px solid #FAD30C; position: relative;">
                            ...
                            <p class="courses-description-paragraph mb-0" style="font-size: 16px; line-height: 1.75; color: #2D2D2D; text-align: justify;">Being grateful for the many blessings in your life won't only increase your happiness levels… it'll also boost your physical health! When you survey your life and truly realize how many things you have to be thankful for, you'll gain even more happiness and peace.</p>
                        </div>
                        ...
                        <div class="courses-highlight-box p-4 mb-4" style="background: linear-gradient(135deg, #F8F9FA 0%, #FFFFFF 100%); border: 2px solid #FAD30C; border-radius: 12px; box-shadow: 0 4px 12px rgba(250, 211, 12, 0.15); position: relative;">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div>
                                    <p class="courses-description-paragraph mb-0" style="font-size: 15px; line-height: 1.7; color: #2D2D2D; font-style: italic;">This module helps you find peace beyond self-focus. <strong style="color: #275BA7; font-weight: 600;">Learn how spiritual connection - defined in your own way - supports emotional balance and confidence.</strong></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 16px; border: none; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.2);">
            <div class="modal-header" style="border-bottom: 2px solid #F0F0F0; padding: 24px 30px;">
                <h5 class="modal-title" id="coursePurchaseModalLabel" style="font-family: 'Oswald', sans-serif; font-weight: 600; font-size: 24px; color: #275BA7; text-transform: uppercase;">Unlock Module 11: Focus on Your Higher Power</h5>
            ...
            <div class="modal-body" style="padding: 30px;">
                <div class="text-center mb-4">
                    ...
                    <h4 style="font-family: 'Oswald', sans-serif; font-weight: 600; color: #2D2D2D; margin-bottom: 12px;">Module 11: Focus on Your Higher Power</h4>
