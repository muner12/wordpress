        ...
        <div class="row g-4 g-lg-5">
            ...
            <div class="col-12 col-lg-6 courses-details-column order-2 order-lg-2">
                <div class="courses-details-content">
                    <h3 class="courses-details-title">Module 11: Building Your Support System</h3>
                    ...
                    <div class="courses-description-text">
                        <p class="courses-description-paragraph">Being grateful for the many blessings in your life won’t only increase your happiness levels… it’ll also boost your physical health! When you survey your life and truly realize how many things you have to be thankful for, you’ll gain even more happiness and peace.</p>
                    </div>
                </div>
            </div>
        </div>
