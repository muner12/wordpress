...
/**
 * Template Name: Blog 15 - Finding Your Purpose: How to Build a Life That Matters
 */
get_header();
?>
<style>
...
<section class="blog-details-page-section bg-white">
    <div class="container">
        ...
        <nav class="blog-breadcrumb">
            ...
            <span>/</span>
            <span>Finding Your Purpose: How to Build a Life That Matters</span>
        </nav>
        ...
        <div class="blog-details-content">
            ...
            <div class="blog-details-header">
                ...
                <h1 class="blog-details-title">
                    <?php 
                    $blog15 = toddpatkin_get_blog_content(15);
                    echo $blog15 ? esc_html($blog15['title']) : 'Finding Your Purpose: How to Build a Life That Matters';
                    ?>
                </h1>
            </div>
            ...
            <div class="blog-details-featured-image mb-5">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/newblog/purpose_blog.png"
                    alt="<?php 
                    $blog15 = toddpatkin_get_blog_content(15);
                    echo $blog15 ? esc_attr($blog15['title']) : 'Finding Your Purpose: How to Build a Life That Matters';
                    ?>"
            ...
            <div class="blog-details-body">
                <?php 
                $blog15 = toddpatkin_get_blog_content(15);
                if ($blog15 && !empty($blog15['content'])) {
                    echo toddpatkin_format_blog_content($blog15['content']);
                } else {
            ...
            <div class="blog-cta-section">
                <h3>Ready to Find Your Purpose?</h3>
                <p>Discover more insights on purpose-driven living, personal transformation, and building a meaningful life. Explore our resources and start your journey today.</p>
