        ...
        <div class="blog-details-content">
            ...
            <div class="blog-details-header">
                ...
                <h1 class="blog-details-title">
                    ...
                    echo $blog6 ? esc_html($blog6['title']) : 'Online While on Vacation? How (and Why) to Unplug';
                    ?>
                </h1>
            </div>
            ...
            <div class="blog-details-body">
                <?php 
                $blog6 = toddpatkin_get_blog_content(6);
                if ($blog6 && !empty($blog6['content'])) {
                    echo toddpatkin_format_blog_content($blog6['content']);
                } else {
                    // Fallback content
