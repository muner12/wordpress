...
/**
 * Template Name: Blog 12 - How to Unplug (Even When It Feels Impossible)
 */
get_header();
?>
<style>
...
<section class="blog-details-page-section bg-white">
    <div class="container">
        ...
        <nav class="blog-breadcrumb">
            ...
            <span>/</span>
            <span>How to Unplug (Even When It Feels Impossible)</span>
        </nav>
        ...
        <div class="blog-details-content">
            ...
            <div class="blog-details-header">
                ...
                <h1 class="blog-details-title">
                    <?php 
                    $blog12 = toddpatkin_get_blog_content(12);
                    echo $blog12 ? esc_html($blog12['title']) : 'How to Unplug (Even When It Feels Impossible)';
                    ?>
                </h1>
            </div>
            ...
            <div class="blog-details-featured-image mb-5">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/newblog/digital_boundries_blog.png"
                    alt="<?php 
                    $blog12 = toddpatkin_get_blog_content(12);
                    echo $blog12 ? esc_attr($blog12['title']) : 'How to Unplug (Even When It Feels Impossible)';
                    ?>"
            ...
            <div class="blog-details-body">
                <?php 
                $blog12 = toddpatkin_get_blog_content(12);
                if ($blog12 && !empty($blog12['content'])) {
                    echo toddpatkin_format_blog_content($blog12['content']);
                } else {
            ...
            <div class="blog-cta-section">
                <h3>Ready to Unplug?</h3>
                <p>Discover more insights on digital wellness, work-life balance, and personal transformation. Explore our resources and start your journey today.</p>
