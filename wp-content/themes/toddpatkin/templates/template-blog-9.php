...
/**
 * Template Name: Blog 9 - 10 Phrases That Will Transform Your Team
 */
get_header();
?>
<style>
...
<section class="blog-details-page-section bg-white">
    <div class="container">
        ...
        <nav class="blog-breadcrumb">
            ...
            <span>/</span>
            <span>10 Phrases That Will Transform Your Team</span>
        </nav>
        ...
        <div class="blog-details-content">
            ...
            <div class="blog-details-header">
                ...
                <h1 class="blog-details-title">
                    <?php 
                    $blog9 = toddpatkin_get_blog_content(9);
                    echo $blog9 ? esc_html($blog9['title']) : '10 Phrases That Will Transform Your Team';
                    ?>
                </h1>
            </div>
            ...
            <div class="blog-details-featured-image mb-5">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/newblog/leadership_blog.png"
                    alt="<?php 
                    $blog9 = toddpatkin_get_blog_content(9);
                    echo $blog9 ? esc_attr($blog9['title']) : '10 Phrases That Will Transform Your Team';
                    ?>"
            ...
            <div class="blog-details-body">
                <?php 
                $blog9 = toddpatkin_get_blog_content(9);
                if ($blog9 && !empty($blog9['content'])) {
                    echo toddpatkin_format_blog_content($blog9['content']);
                } else {
            ...
            <div class="blog-cta-section">
                <h3>Ready to Transform Your Leadership?</h3>
                <p>Discover more insights on leadership, team engagement, and workplace happiness. Explore our resources and start your journey today.</p>
