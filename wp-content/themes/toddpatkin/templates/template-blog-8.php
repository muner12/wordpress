...
/**
 * Template Name: Blog 8 - Beyond Burnout
 */
get_header();
?>
<style>
...
<section class="blog-details-page-section bg-white">
    <div class="container">
        ...
        <nav class="blog-breadcrumb">
            ...
            <span>/</span>
            <span>Beyond Burnout: 14 Micro-Practices to Transform Your Workday in 2025</span>
        </nav>
        ...
        <div class="blog-details-content">
            ...
            <div class="blog-details-header">
                ...
                <h1 class="blog-details-title">
                    <?php 
                    $blog8 = toddpatkin_get_blog_content(8);
                    echo $blog8 ? esc_html($blog8['title']) : 'Beyond Burnout: 14 Micro-Practices to Transform Your Workday in 2025';
                    ?>
                </h1>
            </div>
            ...
            <div class="blog-details-featured-image mb-5">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/newblog/workplace_blog.png"
                    alt="<?php 
                    $blog8 = toddpatkin_get_blog_content(8);
                    echo $blog8 ? esc_attr($blog8['title']) : 'Beyond Burnout: 14 Micro-Practices to Transform Your Workday in 2025';
                    ?>"
            ...
            <div class="blog-details-body">
                <?php 
                $blog8 = toddpatkin_get_blog_content(8);
                if ($blog8 && !empty($blog8['content'])) {
                    echo toddpatkin_format_blog_content($blog8['content']);
                } else {
            ...
            <div class="blog-cta-section">
                <h3>Ready to Transform Your Workday?</h3>
                <p>Discover more insights on workplace happiness, mental health, and personal transformation. Explore our resources and start your journey today.</p>
