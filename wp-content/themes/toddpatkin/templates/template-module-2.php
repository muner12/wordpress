                    ...
                    <div class="courses-video-container w-100">
                        <div class="courses-video-wrapper w-100 position-relative">
                            <img 
                                ...
                                alt="Module 2: Taking Charge of Your Mind"
            ...
            <div class="col-12 col-lg-6 courses-details-column order-2 order-lg-2">
                <div class="courses-details-content">
                    ...
                    <div class="courses-details-header mb-4">
                        <h3 class="courses-details-title mb-3">Module 2: Focus on Movement</h3>
                    ...
                    <div class="courses-description-enhanced">
                        <div class="courses-description-item mb-4" style="padding-left: 28px; border-left: 3px solid #FAD30C; position: relative;">
                            ...
                            <p class="courses-description-paragraph mb-0" style="font-size: 16px; line-height: 1.75; color: #2D2D2D; text-align: justify;">We've all heard "you need to exercise" more times than we can count…but according to Todd, exercise is the single most important thing you can do to become happier right now. Exercise is a natural anti-depressant that will enable you to feel more powerful and less stressed. And what's more, exercising just twenty minutes every other day will open your mind and body up so that they can best receive all of the changes you'll make in the next ten weeks.</p>
                        </div>
                        ...
                        <div class="courses-highlight-box p-4 mb-4" style="background: linear-gradient(135deg, #F8F9FA 0%, #FFFFFF 100%); border: 2px solid #FAD30C; border-radius: 12px; box-shadow: 0 4px 12px rgba(250, 211, 12, 0.15); position: relative;">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div>
                                    <p class="courses-description-paragraph mb-0" style="font-size: 15px; line-height: 1.7; color: #2D2D2D; font-style: italic;">Discover how to manage negative thought patterns and anxiety before they manage you. <strong style="color: #275BA7; font-weight: 600;">Learn practical movement strategies that create immediate positive changes in your mental and physical well-being.</strong></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 16px; border: none; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.2);">
            <div class="modal-header" style="border-bottom: 2px solid #F0F0F0; padding: 24px 30px;">
                <h5 class="modal-title" id="coursePurchaseModalLabel" style="font-family: 'Oswald', sans-serif; font-weight: 600; font-size: 24px; color: #275BA7; text-transform: uppercase;">Unlock Module 2</h5>
            ...
            <div class="modal-body" style="padding: 30px;">
                <div class="text-center mb-4">
                    ...
                    <h4 style="font-family: 'Oswald', sans-serif; font-weight: 600; color: #2D2D2D; margin-bottom: 12px;">Module 2: Taking Charge of Your Mind</h4>
            ...
            <div class="modal-footer" style="border-top: 2px solid #F0F0F0; padding: 20px 30px; justify-content: center;">
                <a href="<?php echo esc_url( home_url( '/course/module-2' ) ); ?>" class="btn btn-warning btn-lg" style="padding: 14px 40px; font-weight: 600; font-size: 16px; text-transform: uppercase; letter-spacing: 0.5px; box-shadow: 0 4px 12px rgba(255, 193, 7, 0.4); transition: all 0.3s ease;">
