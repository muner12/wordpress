...
/**
 * Template Name: Blog 10 - Stop Beating Yourself Up: The Science and Practice of Self-Compassion
 */
get_header();
?>
<style>
...
<section class="blog-details-page-section bg-white">
    <div class="container">
        ...
        <nav class="blog-breadcrumb">
            ...
            <span>/</span>
            <span>Stop Beating Yourself Up: The Science and Practice of Self-Compassion</span>
        </nav>
        ...
        <div class="blog-details-content">
            ...
            <div class="blog-details-header">
                ...
                <h1 class="blog-details-title">
                    <?php 
                    $blog10 = toddpatkin_get_blog_content(10);
                    echo $blog10 ? esc_html($blog10['title']) : 'Stop Beating Yourself Up: The Science and Practice of Self-Compassion';
                    ?>
                </h1>
            </div>
            ...
            <div class="blog-details-featured-image mb-5">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/newblog/perfection_blog.png"
                    alt="<?php 
                    $blog10 = toddpatkin_get_blog_content(10);
                    echo $blog10 ? esc_attr($blog10['title']) : 'Stop Beating Yourself Up: The Science and Practice of Self-Compassion';
                    ?>"
            ...
            <div class="blog-details-body">
                <?php 
                $blog10 = toddpatkin_get_blog_content(10);
                if ($blog10 && !empty($blog10['content'])) {
                    echo toddpatkin_format_blog_content($blog10['content']);
                } else {
            ...
            <div class="blog-cta-section">
                <h3>Ready to Practice Self-Compassion?</h3>
                <p>Discover more insights on self-compassion, mental health, and personal transformation. Explore our resources and start your journey today.</p>
