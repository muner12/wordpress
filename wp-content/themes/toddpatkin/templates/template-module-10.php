...
<section class="courses-page-section">
    <div class="container">
        ...
        <div class="courses-breadcrumb mb-4">
            ...
            <span class="courses-breadcrumb-separator">></span>
            <span class="courses-breadcrumb-current">Module 10</span>
        </div>
                ...
                <div class="col-12 col-lg-6 courses-video-column order-1 order-lg-1">
                    <div class="courses-video-container w-100">
                        <div class="courses-video-wrapper w-100 position-relative">
                            <img 
                                src="<?php echo get_template_directory_uri(); ?>/assets/images/week_10.png" 
                                alt="Module 10: Helping Others"
            ...
            <div class="col-12 col-lg-6 courses-details-column order-2 order-lg-2">
                <div class="courses-details-content">
                    ...
                    <div class="courses-details-header mb-4">
                        <h3 class="courses-details-title mb-3">Module 10: Focus on Helping Others</h3>
                    ...
                    <div class="courses-description-enhanced">
                        <div class="courses-description-item mb-4" style="padding-left: 28px; border-left: 3px solid #FAD30C; position: relative;">
                            <div class="courses-icon-badge" style="position: absolute; left: -14px; top: 0; width: 28px; height: 28px; background: #FAD30C; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 8px rgba(250, 211, 12, 0.4);">
                                <i class="fas fa-hands-helping" style="color: #1a1a1a; font-size: 14px;"></i>
                            </div>
                            <p class="courses-description-paragraph mb-0" style="font-size: 16px; line-height: 1.75; color: #2D2D2D; text-align: justify;">Givers are happy people because, on some level or other, we are all wired to be social beings, and we find our greatest fulfillment in helping others. When you give your time, talents, and/or resources to make another's life better, you'll experience increased perspective and self-esteem, and you'll also become more connected to your own blessings.</p>
                        </div>
                        ...
                        <div class="courses-highlight-box p-4 mb-4" style="background: linear-gradient(135deg, #F8F9FA 0%, #FFFFFF 100%); border: 2px solid #FAD30C; border-radius: 12px; box-shadow: 0 4px 12px rgba(250, 211, 12, 0.15); position: relative;">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div>
                                    <p class="courses-description-paragraph mb-0" style="font-size: 15px; line-height: 1.7; color: #2D2D2D; font-style: italic;">Why giving back is one of the most powerful tools for your own recovery. <strong style="color: #275BA7; font-weight: 600;">Learn how helping others creates a positive cycle of fulfillment and happiness in your own life.</strong></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 16px; border: none; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.2);">
            <div class="modal-header" style="border-bottom: 2px solid #F0F0F0; padding: 24px 30px;">
                <h5 class="modal-title" id="coursePurchaseModalLabel" style="font-family: 'Oswald', sans-serif; font-weight: 600; font-size: 24px; color: #275BA7; text-transform: uppercase;">Unlock Module 10</h5>
            ...
            <div class="modal-body" style="padding: 30px;">
                <div class="text-center mb-4">
                    ...
                    <h4 style="font-family: 'Oswald', sans-serif; font-weight: 600; color: #2D2D2D; margin-bottom: 12px;">Module 10: The Service Secret</h4>
            ...
            <div class="modal-footer" style="border-top: 2px solid #F0F0F0; padding: 20px 30px; justify-content: center;">
                <a href="<?php echo esc_url( home_url( '/course/module-10' ) ); ?>" class="btn btn-warning btn-lg" style="padding: 14px 40px; font-weight: 600; font-size: 16px; text-transform: uppercase; letter-spacing: 0.5px; box-shadow: 0 4px 12px rgba(255, 193, 7, 0.4); transition: all 0.3s ease;">
