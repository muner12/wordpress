        ...
        <div class="row g-4 g-lg-5">
            ...
            <div class="col-12 col-lg-6 courses-details-column order-2 order-lg-2">
                <div class="courses-details-content">
                    <h3 class="courses-details-title">Module 10: The Service Secret</h3>
                    ...
                    <div class="courses-description-text">
                        <p class="courses-description-paragraph">Givers are happy people because, on some level or other, we are all wired to be social beings, and we find our greatest fulfillment in helping others. When you give your time, talents, and/or resources to make another’s life better, you’ll experience increased perspective and self-esteem, and you’ll also become more connected to your own blessings.</p>
                    </div>
                </div>
            </div>
        </div>
