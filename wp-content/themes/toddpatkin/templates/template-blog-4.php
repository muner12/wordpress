...
/**
 * Template Name: Blog 4 - The Power of Gratitude
 */
get_header();
?>
<style>
...
<section class="blog-details-page-section bg-white">
    <div class="container">
        ...
        <nav class="blog-breadcrumb">
            ...
            <span>/</span>
            <span>The Power of Gratitude</span>
        </nav>
        ...
        <div class="blog-details-content">
            ...
            <div class="blog-details-featured-image mb-5">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog-featured-1-41dc6a.png"
