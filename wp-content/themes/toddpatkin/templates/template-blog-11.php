...
/**
 * Template Name: Blog 11 - Breaking the Silence: Mental Health in the Modern Workplace
 */
get_header();
?>
<style>
...
<section class="blog-details-page-section bg-white">
    <div class="container">
        ...
        <nav class="blog-breadcrumb">
            ...
            <span>/</span>
            <span>Breaking the Silence: Mental Health in the Modern Workplace</span>
        </nav>
        ...
        <div class="blog-details-content">
            ...
            <div class="blog-details-header">
                ...
                <h1 class="blog-details-title">
                    <?php 
                    $blog11 = toddpatkin_get_blog_content(11);
                    echo $blog11 ? esc_html($blog11['title']) : 'Breaking the Silence: Mental Health in the Modern Workplace';
                    ?>
                </h1>
            </div>
            ...
            <div class="blog-details-featured-image mb-5">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/newblog/breaking_blog.png"
                    alt="<?php 
                    $blog11 = toddpatkin_get_blog_content(11);
                    echo $blog11 ? esc_attr($blog11['title']) : 'Breaking the Silence: Mental Health in the Modern Workplace';
                    ?>"
            ...
            <div class="blog-details-body">
                <?php 
                $blog11 = toddpatkin_get_blog_content(11);
                if ($blog11 && !empty($blog11['content'])) {
                    echo toddpatkin_format_blog_content($blog11['content']);
                } else {
            ...
            <div class="blog-cta-section">
                <h3>Ready to Break the Silence?</h3>
                <p>Discover more insights on mental health, workplace wellness, and personal transformation. Explore our resources and start your journey today.</p>
