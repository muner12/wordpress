...
/**
 * Template Name: Blog 14 - Stop Beating Yourself Up: The Science and Practice of Self-Compassion
 */
get_header();
?>
<style>
        ...
        <div class="blog-details-content">
            ...
            <div class="blog-details-header">
                ...
                <h1 class="blog-details-title">
                    <?php 
                    $blog14 = toddpatkin_get_blog_content(14);
                    echo $blog14 ? esc_html($blog14['title']) : 'Stop Beating Yourself Up: The Science and Practice of Self-Compassion';
                    ?>
                </h1>
            </div>
            ...
            <div class="blog-details-featured-image mb-5">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/newblog/self_compassion.png"
                    alt="<?php 
                    $blog14 = toddpatkin_get_blog_content(14);
                    echo $blog14 ? esc_attr($blog14['title']) : 'Stop Beating Yourself Up: The Science and Practice of Self-Compassion';
                    ?>"
            ...
            <div class="blog-details-body">
                <?php 
                $blog14 = toddpatkin_get_blog_content(14);
                if ($blog14 && !empty($blog14['content'])) {
                    echo toddpatkin_format_blog_content($blog14['content']);
                } else {
