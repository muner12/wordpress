        ...
        <div class="row g-4 g-lg-5">
                ...
                <div class="col-12 col-lg-6 courses-video-column order-1 order-lg-1">
                    <div class="courses-video-container w-100">
                        <div class="courses-video-wrapper w-100 position-relative" style="padding-bottom: 56.25%; height: 0; overflow: hidden;">
                            <iframe 
                                src="https://www.youtube.com/embed/wqH41CujmFc" 
                                frameborder="0" 
            ...
            <div class="col-12 col-lg-6 courses-details-column order-2 order-lg-2">
                <div class="courses-details-content">
                    <h3 class="courses-details-title">Module 1: Being Easier on Yourself</h3>
                    ...
                    <div class="courses-description-text">
                        <p class="courses-description-paragraph">It’s true: You are your own worst critic. And you’ll never have a real shot at happiness if you’re always beating yourself up for mistakes and doubting your own abilities. Once you refocus the way you look at life and direct your attention to all of the things you do well instead of fixating on slip-ups and shortcomings, you’ll begin to have an altogether more positive life.</p>
                    </div>
                </div>
            </div>
        </div>
